...
Use repository business knowledge before changing complex AI workflow code. Start from `ArtVerse/docs/knowledge/INDEX.md`, then read only the module skill that matches the task.

- Manga agent chat, SSE runs, HITL resume, AgentScope tools, run persistence: `ArtVerse/docs/knowledge/modules/manga-agent/SKILL.md`.
